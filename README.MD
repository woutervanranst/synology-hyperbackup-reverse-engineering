...
Verified against the author's own Synology backups on Azure — one encrypted, one
unencrypted — with restores checked byte-for-byte against the original source files.
